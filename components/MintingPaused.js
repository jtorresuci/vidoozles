...
return(
    ...
    pr={["0", sidePadding]} pt="5rem">
        <Center pb="3rem" fontSize={"20pt"} fontFamily={"BodoAmat"}>Vidoozles Minting has been paused, we will be back soon. Prepare for Phase 2.
</Center>
    <Grid
      ...
      <Box>
        <Center>
          <VStack p="2rem" >
            ...
            <Button borderRadius={"20px"} color="white" className="color-change-2x" disabled={"true"} onTouchStart={() => handleMint()} onClick={handleMint}>
