...
const sidePadding = "5"
const SocialsReverse = (props, ButtonGroupProps) => {
    return (
        <ButtonGroup     
        ...
        <IconButton color="white" pl={["0", sidePadding]} pr={["0", sidePadding]} _hover={{ color: hoverColor  }} as="a" href={discordHandle} aria-label="Discord" icon={<FaDiscord size={["5px", "60px"]} />} />

        <IconButton color="white" pl={["0", sidePadding]} pr={["0", sidePadding]} _hover={{ color: hoverColor  }} as="a" href={twitterHandle} aria-label="Twitter" icon={<FaTwitter size={["5px", "60px"]} />} />
